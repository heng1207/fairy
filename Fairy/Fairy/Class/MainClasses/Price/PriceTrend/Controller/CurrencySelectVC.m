...
- (void)viewDidLoad {
    ...
    hintLab.frame = CGRectMake(AdaptedWidth(24), AdaptedWidth(24), UIScreenW-AdaptedWidth(48), AdaptedWidth(30));
...
-(void)creatBtnView{
    ...
    backView.frame = CGRectMake(0,AdaptedWidth(78) ,UIScreenW, margin + hangNum*(space+height));
