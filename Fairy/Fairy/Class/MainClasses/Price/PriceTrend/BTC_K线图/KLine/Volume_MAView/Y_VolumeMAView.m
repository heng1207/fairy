...
@property (strong, nonatomic) UILabel *VolumeMA15Label;
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _VolumeMA15Label = [self private_createLabel];
        ...
        _VolumeMA15Label.textColor = [UIColor ma15Color];
        ...
        [_VolumeMA15Label mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        [_VolumeMA30Label mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(_VolumeMA15Label.mas_right);
            make.top.equalTo(self.mas_top);
            make.bottom.equalTo(self.mas_bottom);
        }];
...
-(void)maProfileWithModel:(Y_KLineModel *)model
{
    ...
    _volumeDescLabel.text = [NSString stringWithFormat:@" 量:%.4f ",model.Volume];
 
    _VolumeMA7Label.text = [NSString stringWithFormat:@"  MA7：%.4f ",model.Volume_MA7.floatValue];
    _VolumeMA15Label.text = [NSString stringWithFormat:@"  MA15：%.4f ",model.Volume_MA15.floatValue];
