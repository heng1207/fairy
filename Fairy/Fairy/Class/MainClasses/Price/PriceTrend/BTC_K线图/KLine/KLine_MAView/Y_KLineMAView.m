...
@property (strong, nonatomic) UILabel *MA15Label;
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _MA15Label = [self private_createLabel];
...
//            make.bottom.equalTo(self.mas_bottom);
        ...
        [_MA15Label mas_makeConstraints:^(MASConstraintMaker *make) {
...
//            make.bottom.equalTo(self.mas_bottom);
            ...
            make.left.equalTo(_MA15Label.mas_right);
            make.top.equalTo(self.openLabel.mas_bottom);
            make.bottom.equalTo(self.mas_bottom);
        }];
...
//    _dateDescLabel.text = [@" " stringByAppendingString: dateStr];
    _dateDescLabel.text = model.Date;
    ...
    _MA15Label.text = [NSString stringWithFormat:@" MA15：%.2f ",model.MA15.floatValue];
