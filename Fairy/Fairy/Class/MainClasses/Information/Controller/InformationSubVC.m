...
- (UITableView *)myTableView {
    if (!_myTableView) {
        _myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - 44-LL_TabbarHeight -LL_StatusBarHeight) style:UITableViewStylePlain];
