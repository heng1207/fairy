...
#import "CompareXAxisView.h"
#import "CompareYAxisView.h"
...
@interface CompareChartView ()<UIScrollViewDelegate>

@property (strong, nonatomic) NSArray *xTitleArray;
@property (strong, nonatomic) NSArray *yValueArray;
@property (assign, nonatomic) CGFloat yMax;
@property (assign, nonatomic) CGFloat yMin;
@property (strong, nonatomic) CompareYAxisView *yAxisView;
@property (strong, nonatomic) CompareXAxisView *xAxisView;
...
@implementation CompareChartView
...
- (id)initWithFrame:(CGRect)frame xTitleArray:(NSArray*)xTitleArray yValueArray:(NSArray*)yValueArray yMax:(CGFloat)yMax yMin:(CGFloat)yMin LineType:(NSString *)lineType {
    ...
    if (self) {
        ...
        UILabel *startLab=[[UILabel alloc]initWithFrame:CGRectMake(0, self.height-10, 80, 10)];
        ...
        UILabel *endLab=[[UILabel alloc]initWithFrame:CGRectMake(self.width-leftMargin -80, self.height-10, 80, 10)];
        self.endLab = endLab;
        ...
        UILabel *priceUSDLab=[[UILabel alloc]initWithFrame:CGRectMake(0, 10, SCREEN_WIDTH, 15)];
...
- (void)creatYAxisView {
    ...
    self.yAxisView = [[CompareYAxisView alloc]initWithFrame:CGRectMake(self.frame.size.width-leftMargin, 0, leftMargin, self.frame.size.height) yMax:self.yMax yMin:self.yMin];
...
- (void)creatXAxisView {
    ...
    self.xAxisView = [[CompareXAxisView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width-leftMargin, self.frame.size.height) xTitleArray:self.xTitleArray yValueArray:self.yValueArray yMax:self.yMax yMin:self.yMin PointGap:self.pointGap];
