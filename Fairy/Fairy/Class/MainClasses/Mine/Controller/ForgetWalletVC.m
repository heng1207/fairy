...
@interface ForgetWalletVC ()<UITextFieldDelegate>
//naviview
...
- (void)createCodeLoginView
{
    ...
    self.phoneTF.text = [kUserDefaults objectForKey:KphoneNumber];
    ...
    [self.codeBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(lineView1.mas_bottom).offset(kScreenValue(7));
    ...
    [lineView2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.codeTF.mas_bottom).offset(kScreenValue(17));
        make.left.equalTo(self.view.mas_left).offset(kScreenValue(0));
        make.right.equalTo(self.view.mas_right).offset(kScreenValue(0));
        make.height.mas_equalTo(kScreenValue(1));
    }];
